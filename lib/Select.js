...
var Select = function (_React$Component) {
   ...
   */
		...
		value: function renderInput(valueArray, focusedOptionIndex) {
			...
			var inputProps = _extends({}, this.props.inputProps, (_extends2 = {
			...
			}, _defineProperty(_extends2, 'tabIndex', this.props.tabIndex), _defineProperty(_extends2, 'value', value), _extends2));
...
Select.propTypes = {
	...
	keepCursorAtEnd: _propTypes2.default.bool, // keeps the cursor at the end of the input (for non multi selects)
